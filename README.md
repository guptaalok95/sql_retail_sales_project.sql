...
Project Overview
This project performs an end-to-end retail sales analysis using MySQL, focusing on data quality, customer behavior, revenue growth, profitability, and business insights. The goal of this project is to demonstrate advanced SQL skills and the ability to translate raw transactional data into actionable business insights.
Tools & Technologies
Database: MySQL 8+
...
Data anomaly detection (validated total sales against quantity × price)
...
Customer Churn Analysis (customers inactive for last 3 months)
...
│
├──SQL_Retail Sales Analysis_utf .csv    -- Raw data
...
Run retail_sales_schema.sql to create the database & table
Load the csv dataset into retail_sales
Execute retail_sales_analysis.sql
Key Takeaway
...
LinkedIn: (www.linkedin.com/in/alok-gupta-a7bb5b260) GitHub: (github.com/guptaalok95 )
